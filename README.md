...
This is a website I personally developed in order to showcase who I am and what projects I have in my portfolio. The aim of the website is to impress potential employers with the displayed portfolio.

# Overall Functionality
The website was designed to be easily navigatable and engaging while easily understandable. This is achieved with:
...
- Contact form utilising [Formspree](https://formspree.io/) as an API in order for messages to be sent (emailed) directly from the web page to me.
...
My sites Fuctionality and features is also detailed below as a walk through of each page.
...
I was inspired by an art gallery aesthetic when it came to my portfolio overall. I wanted my homepage to invoke feelings of ambiguity and intrigue as I believe this will spark the curiousity in people and drive them to delve further in the site. I achieved this by making my landing page a simple logo with a website navigator to the left and social links to the bottom.
...
## About Me
![alt text](../myportfolio/docs/About%20Me%20Page.png)
...
- Quote has absolute position until screen size strinks, then position becomes relative in order for the page to have a column view.
...
The Projects page highlights the projects I have created. The projects are displayed as tiles that reveal an image and information when hovered over by a mouse. Clicking on the read more will direct to the project’s individual page. The tiles also feature a 3D reflective effect that is applied trhourhg javascript. As there is no hovering for touch screen devices, the hover feature is disabled for these users so that the information can still be seen. Flex box makes the tiles easily viewable regardless of screen size.

The final page differs from the wireframes as later on in the development I realised that during the planning phase I was overcomplicating the site in a attempt to feature as many different styling methods as possible. In order to uncomplicate the design of the website I opted to scrap the original design and redesign for consistant features/functions.
...
Same as the Projects page, the page feature evenly spread out tiles that reveal information when hovered over with read more <"a"> links that direct to individual blog's page. As these pages were showcasing information, for consistancy sake the formatting was kept similar as to not overcomplicate the design.
## Inividial Blog Page
![alt text](./docs/Blog%20individual%20page.png)
![alt text](docs\blog-individual-page.PNG)
The individual blog page is simple in design. With an image & header at the top to attract attention, then the article content below. Depending on the content of the article, more elements can be added to expand the size of the content ie. more images or external embeded links. The page is kept within a certain width for easiler reading with maintained focus on the center of the page.
## Contact Me
